...
export const UI = {
  ru: {
    ...
    custom: {
      pick: 'Свой текст',
      hint: 'Свой рассказ, разбитый на склады',
      title: 'Свой текст для чтения',
      topicLabel: 'Тема рассказа',
      topicPlaceholder: 'например: про кота',
      topics: ['🐱 про кота', '🐶 про щенка', '❄️ зима', '🚀 космос', '🎂 праздник', '🏠 дома', '🌳 лес', '🚂 поезд'],
      lengthLabel: 'Длина рассказа',
      wordsN: '{n} слов',
      levelLabel: 'Длина предложений',
      generate: '✨ Придумать рассказ',
      generating: 'Придумываю…',
      textLabel: 'Текст',
      textPlaceholder: 'Напиши или вставь текст — приложение разобьёт его на склады',
      sentencesN: 'Получится предложений: {n}',
      keyToggle: '⚙ Ключ Claude API',
      keyPlaceholder: 'sk-ant-…',
      keyHint: 'Ключ нужен только для кнопки «Придумать рассказ». Он хранится в этом браузере и уходит прямо в api.anthropic.com — свой ключ на своём устройстве.',
      clear: 'Очистить',
      read: 'Читать',
      cancel: 'Отмена',
      errors: {
        key: 'Сначала введи ключ Claude API',
        auth: 'Ключ не подошёл — проверь его',
        rate: 'Слишком много запросов — попробуй через минуту',
        network: 'Нет связи с api.anthropic.com',
        refusal: 'Claude не стал писать такой рассказ — поменяй тему',
        api: 'Не получилось: {message}',
        empty: 'Сначала напиши или придумай текст'
      }
    },
    common: {
      toMenu: 'В меню',
      ...
      trackOff: 'Включить ползунок под текстом',
      trackHint: 'Тяни ползунок пальчиком — буква подсветится',
  ...
  be: {
    ...
    custom: {
      pick: 'Свой тэкст',
      hint: 'Сваё апавяданне, разбітае на склады',
      title: 'Свой тэкст для чытання',
      topicLabel: 'Тэма апавядання',
      topicPlaceholder: 'напрыклад: пра кота',
      topics: ['🐱 пра кота', '🐶 пра сабачку', '❄️ зіма', '🚀 космас', '🎂 свята', '🏠 дома', '🌳 лес', '🚂 поезд'],
      lengthLabel: 'Даўжыня апавядання',
      wordsN: '{n} словаў',
      levelLabel: 'Даўжыня сказаў',
      generate: '✨ Прыдумаць апавяданне',
      generating: 'Прыдумваю…',
      textLabel: 'Тэкст',
      textPlaceholder: 'Напішы ці ўстаў тэкст — праграма разаб’е яго на склады',
      sentencesN: 'Атрымаецца сказаў: {n}',
      keyToggle: '⚙ Ключ Claude API',
      keyPlaceholder: 'sk-ant-…',
      keyHint: 'Ключ патрэбны толькі для кнопкі «Прыдумаць апавяданне». Ён зберагаецца ў гэтым браўзеры і йдзе адразу ў api.anthropic.com — свой ключ на сваёй прыладзе.',
      clear: 'Ачысціць',
      read: 'Чытаць',
      cancel: 'Адмена',
      errors: {
        key: 'Спачатку ўвядзі ключ Claude API',
        auth: 'Ключ не падышоў — правер яго',
        rate: 'Занадта многа запытаў — паспрабуй праз хвіліну',
        network: 'Няма звязку з api.anthropic.com',
        refusal: 'Claude не стаў пісаць такое апавяданне — памяняй тэму',
        api: 'Не атрымалася: {message}',
        empty: 'Спачатку напішы ці прыдумай тэкст'
      }
    },
    common: {
      toMenu: 'У меню',
      ...
      trackOff: 'Уключыць паўзунок пад тэкстам',
      trackHint: 'Цягні паўзунок пальчыкам — літара падсвеціцца',
  ...
  uk: {
    ...
    custom: {
      pick: 'Свій текст',
      hint: 'Своє оповідання, поділене на склади',
      title: 'Свій текст для читання',
      topicLabel: 'Тема оповідання',
      topicPlaceholder: 'наприклад: про кота',
      topics: ['🐱 про кота', '🐶 про цуценя', '❄️ зима', '🚀 космос', '🎂 свято', '🏠 дома', '🌳 ліс', '🚂 поїзд'],
      lengthLabel: 'Довжина оповідання',
      wordsN: '{n} слів',
      levelLabel: 'Довжина речень',
      generate: '✨ Придумати оповідання',
      generating: 'Придумую…',
      textLabel: 'Текст',
      textPlaceholder: 'Напиши або встав текст — застосунок поділить його на склади',
      sentencesN: 'Вийде речень: {n}',
      keyToggle: '⚙ Ключ Claude API',
      keyPlaceholder: 'sk-ant-…',
      keyHint: 'Ключ потрібен лише для кнопки «Придумати оповідання». Він зберігається в цьому браузері й іде прямо в api.anthropic.com — свій ключ на своєму пристрої.',
      clear: 'Очистити',
      read: 'Читати',
      cancel: 'Скасувати',
      errors: {
        key: 'Спочатку введи ключ Claude API',
        auth: 'Ключ не підійшов — перевір його',
        rate: 'Занадто багато запитів — спробуй за хвилину',
        network: 'Немає зв’язку з api.anthropic.com',
        refusal: 'Claude не став писати таке оповідання — зміни тему',
        api: 'Не вийшло: {message}',
        empty: 'Спочатку напиши або придумай текст'
      }
    },
    common: {
      toMenu: 'У меню',
      ...
      trackOff: 'Увімкнути повзунок під текстом',
      trackHint: 'Тягни повзунок пальчиком — літера підсвітиться',
